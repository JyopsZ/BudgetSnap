...
public class budgeting1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void gonotif(View v) {
            Intent i = new Intent(budgeting1.this, Notifications.class);
            startActivity(i);
        }

        public void gosavings(View v) {
            Intent i = new Intent(budgeting1.this, savings.class);
            startActivity(i);
        }

        public void gobudgeting(View v) {
            Intent i = new Intent(budgeting1.this, budgeting1.class);
            startActivity(i);
        }
        ...
        public void gocategories(View v) {
            Intent i = new Intent(budgeting1.this, categories.class);
            startActivity(i);
        }
